...
import { rickandmorty, rickandmorty_poster1, rickandmorty_poster2 } from '@/public/assets';
      ...
      <div className="min-h-screen  text-white p-4 lg:p-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
            ...
            <Link
            href={"/characters"} 
              className="group bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 overflow-hidden hover:border-[#03B9AD] hover:shadow-2xl hover:shadow-green-400/20 transition-all duration-300 cursor-pointer transform hover:scale-105"
            ...
            >
              ...
              <div className="p-6">
                <h2 className="text-2xl lg:text-3xl font-bold mb-2 group-hover:text-[#03B9AD] transition-colors">
                  Characters
                </h2>
                <p className="text-gray-400 text-sm lg:text-base">
                  Meet the wild cast of characters across the multiverse
                </p>
                <div className="mt-4 flex items-center text-[#03B9AD] opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <Link
           href={"/locations"}  
              className="group md:col-span-2 bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 overflow-hidden hover:border-[#03B9AD] hover:shadow-2xl hover:shadow-green-400/20 transition-all duration-300 cursor-pointer transform hover:scale-105"
             
            >
              <div className="flex flex-col lg:flex-row">
                <div className="relative overflow-hidden lg:w-80">
                  <Image 
                    src={rickandmorty_poster1} 
                ...
                <div className="p-6 lg:p-8 flex-1 flex flex-col justify-center">
                  <h2 className="text-2xl lg:text-4xl font-bold mb-3 group-hover:text-[#03B9AD] transition-colors">
                    Locations
                  </h2>
                  ...
                  <div className="flex items-center text-[#03B9AD] opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="text-center p-6 bg-gray-800/30 rounded-lg border border-gray-700">
              <div className="text-3xl font-bold text-[#03B9AD] mb-2">500+</div>
